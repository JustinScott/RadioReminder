...
public class MyIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "tt.co.justins.radio.radioreminder.action.FOO";
    private static final String ACTION_BAZ = "tt.co.justins.radio.radioreminder.action.BAZ";
